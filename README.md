...
7. **Asyncronous Application Side Effects Processing** - Manage your API calls by writing sagas using Redux-Saga
8. **Forked From Slingshot** - Has all the quality and features Slingshot gave us, plus Sagas and more.

[![React Slingshot Production Build](https://img.youtube.com/vi/qlfDLsX-J0U/0.jpg)](https://www.youtube.com/watch?v=qlfDLsX-J0U)

## Get Started

1. **Initial Machine Setup**. First time running the starter kit? Then complete the [Initial Machine Setup](https://github.com/gruberchris/react-starman#initial-machine-setup).
2. **Clone the project**. `git clone https://github.com/gruberchris/react-starman.git`.
...
6. **Delete the example app files.** Once you're comfortable with how the example app works, you can [delete those files and begin creating your own app](https://github.com/gruberchris/react-starman/blob/master/docs/FAQ.md#i-just-want-an-empty-starter-kit). 
...
1. Make sure you ran all steps in [Get started](https://github.com/gruberchris/react-starman/blob/master/README.md#get-started) including the [initial machine setup](https://github.com/gruberchris/react-starman#initial-machine-setup).
